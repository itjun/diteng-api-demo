...
public class DitengServiceTest {
    ...
    @Test
    public void test() {
        String json = "{\"head\":{\"CusCode_\":\"C00398\",\"TBDate_\":\"2021-12-07\",\"ManageNo_\":\"153491985015702\"},\"body\":[[\"PartCode_\",\"Desc_\",\"Spec_\",\"Num_\",\"SpareNum_\",\"OriUP_\"],[\"0212DYRDR40350\",\"\",\"\",5,0,3],[\"0212DYRDR40350\",\"\",\"\",3,3,3],[\"11L20DLX-1\",\"\",\"\",13,0,1.5]]}";
        DataSet dataSet = new DataSet().setJson(json);
        DitengService svr = new DitengService("tranod.append");
        DataRow headIn = svr.dataIn().head();
        headIn.setValue("CusCode_", "C00398");
        headIn.setValue("TBDate_", "2021-12-07");
